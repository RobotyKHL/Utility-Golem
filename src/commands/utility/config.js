...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(sub =>
      sub.setName("commands").setDescription("Sets the commands channel to block messages.").addChannelOption(opt => opt.setName("channel").setDescription("Where to set the commands channel")).addBooleanOption(opt => opt.setName("addremove").setDescription("To set the channel (true), or to set it to nothing. (false)")))
    .addSubcommand(sub =>
      sub.setName('module')
